          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                id="hoursPerDay"
                name="hoursPerDay"
                className="block w-full pl-10 pr-3 py-3 border border-[#e5beb3] rounded-lg bg-[#fff8f6] text-sm text-[#281813] focus:outline-none focus:ring-2 focus:ring-[#FD5212] focus:border-transparent transition-all duration-200"
              />
            </div>
          </div>
      ...
      {initial.length === 0 ? (
        ...
        <div className="overflow-hidden rounded-2xl border border-[#d2baa9] bg-white shadow-sm">
          <table className="w-full text-sm">
            ...
            <tbody>
              {initial.map((e) => (
                <tr key={e.id} className="border-t border-[#d2baa9]/40 hover:bg-[#E8D7CA]/10 transition-colors">
                  <td className="px-5 py-3 font-bold text-[#281813]">{e.name}</td>
                  <td className="px-5 py-3 text-[#5c4038] font-medium">{VECTOR_LABEL[e.vector]}</td>
                  <td className="px-5 py-3 text-right text-[#5c4038] font-semibold">{Number(e.power)}</td>
                  <td className="px-5 py-3 text-right text-[#5c4038] font-semibold">{Number(e.hoursPerDay)}</td>
                  <td className="px-5 py-3 text-right text-[#5c4038] font-semibold">{e.daysPerMonth}</td>
